...
import { createOperation } from "@/app/lib/data";
...
export default function AddOperationModal({
    ...
    return (
        <Modal isOpen={isOpen} onClose={handleClose} title="Add New Operation">
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="is_active_op" className="text-sm text-gray-700">
                        Active
                    </label>
                </div>
