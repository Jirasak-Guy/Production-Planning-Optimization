            ...
            <div className="px-6 py-4">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-500 text-sm mt-1">Manage work shifts and schedules</p>
                    </div>
            ...
            <div className="flex-1 overflow-auto p-6">
                                ...
                                >
                                    ...
                                    <div className="p-5">
                                        ...
                                        <div className="flex items-center justify-between mb-4">
                                            ...
                                            <div className="flex-1 px-4">
                                                <div className="relative">
                                                    ...
                                                    <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ${colors.light} px-2 py-1 rounded-full`}>
                                        ...
                                        <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                                            <span className="text-xs text-gray-400">ID: {shift.id}</span>
                                            {shift.is_active ? (
                ...
                {shifts.length === 0 && !isLoading && (
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-400 text-sm">Add shifts to get started</p>
                    </div>
                )}
            </div>
        </div>
